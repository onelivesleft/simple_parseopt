...
proc param_from_nodes(name_node: Nim_Node, kind: Param_Kind, value_node: Nim_Node, pragma_node: Nim_Node): (Param, string) =
    ...
    var float_sign = +1.0;
    var node = value_node;
    if node.kind == nnk_prefix:
        if node[0].kind == nnk_ident and node[0].str_val == "-":
            sign = -1;
            float_sign = -1;
        node = node[1];
    ...
    if node == nil:
        ...
        case kind:
        of param_undefined:  param = Param(name: name, kind: param_undefined)
        of param_int:        param = Param(name: name, kind: param_int,        int_value:        cast[int](node.int_val * sign))
        of param_i8:         param = Param(name: name, kind: param_i8,         i8_value:         cast[int8](node.int_val * sign))
        of param_i16:        param = Param(name: name, kind: param_i16,        i16_value:        cast[int16](node.int_val * sign))
        of param_i32:        param = Param(name: name, kind: param_i32,        i32_value:        cast[int32](node.int_val * sign))
        of param_i64:        param = Param(name: name, kind: param_i64,        i64_value:        node.int_val * sign)
        of param_uint:       param = Param(name: name, kind: param_uint,       uint_value:       cast[uint](node.int_val))
        of param_u8:         param = Param(name: name, kind: param_u8,         u8_value:         cast[uint8](node.int_val))
        of param_u16:        param = Param(name: name, kind: param_u16,        u16_value:        cast[uint16](node.int_val))
        of param_u32:        param = Param(name: name, kind: param_u32,        u32_value:        cast[uint32](node.int_val))
        of param_u64:        param = Param(name: name, kind: param_u64,        u64_value:        cast[uint64](node.int_val))
        of param_float:      param = Param(name: name, kind: param_float,      float_value:      node.float_val * float_sign)
        of param_f32:        param = Param(name: name, kind: param_f32,        f32_value:        node.float_val * float_sign)
        of param_f64:        param = Param(name: name, kind: param_f64,        f64_value:        node.float_val * float_sign)
        of param_char:       param = Param(name: name, kind: param_char,       char_value:       cast[char](node.int_val))
        of param_string:     param = Param(name: name, kind: param_string,     string_value:     node.str_val)
        of param_bool:       param = Param(name: name, kind: param_bool,       bool_value:       node.str_val == "true")
        ...
        proc `proc_name`(options: var `type_name`,
            ...
            for index in `required_indexes`:
                ...
                if not is_supplied(addr supplied, name):
                    parse_error("Value required for: " & get_prefix(name) & name)
                    missing = true
            if missing:
